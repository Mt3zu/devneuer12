<?php
ob_start();
$API_KEY = "7085540770:AAHjs6d82P3B2cKFqfa5AnPWNYmai_pG66E";// توكن بوتك العزيز
$buy = "@bb44g";//  يوزرك تليكرام .
$vhhhhh = "bb44g";//  يوزرك تليكرام . 
$sudo = "6587251262";// خلي ايديك هنا .
$admin = "$sudo";// عوفة لا تبعبص بي .
$idBot = "7085540770";// ايدي بوتك خلي بشكل صحيح .
$admmm = $sudo;// لا تبعصة عوفة .
$Dev = array("$sudo", "" );
$userrr = "O4SBBbot"; # خلي معرف بوتك بدون نيم ( @ )
...
$Dev = array("$admmm","6587251262"); # حط ايدي المطور ثاني المساعد او بكيفك خلي ايديك .
$channel = "nn00x";
$token = API_KEY;
...
file_put_contents("SudoOrders/namebot.txt","نوير");
bot("sendMessage",["chat_id"=>$chat_id,'text'=>"⌔︙اهلا عزيزي » [$info](tg://user?id=$from_id) \n⌔︙ارسل اسم البۄت الان \n ✓",'parse_mode'=>"MARKDOWN",'reply_to_message_id'=>$message_id,]);}}
...
$botproxre = array("صيحولي نوير كافي بوت 😒🔪","لتكول بوت اسمي نوير 😒🔪","عندي اسم تره 😒💔","انت البوت لك 😒💔");
...
$proxre = array("😸♥️ هلا كلبي وياك نوير تفضل","ترةه مصختهاا احجيي شرايد 😕😒💔","اطلقق واحدد يصيح نوير 😻♥️","خبصتت امنةة شتريدد عااد 🤧😒💔");
$reprox = array_rand($proxre, 1);
if($text == "نوير" and $namebot == NULL){
if ($tc == 'group' | $tc == 'supergroup'){
...
bot('sendmessage',['chat_id'=>$chat_id,'text'=>"⌔︙مرحبا انا بوت اسمي نوير
⌔︙[اضغط هنا الصنع بوت مجاني حمايه](t.me/bb44g)
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"⌔︙*اهلا بك مجددا عزيزي المطور *\n⌔︙*اليك الازرار الخاصه بتعديل وتغيير كلايش سورس نوير فقط اضغط على الامر الذي تريد تنفيذه*",
'parse_mode'=>'MarkDown',
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
'inline_keyboard'=>[
[
['text'=>"$dataadd",'url'=>"https://t.me/bb44g"]
],
]
])
]);
...
⌔︙[ اضغط هنا لديك مفاجئه ](https://t.me/bb44g)",'parse_mode'=>"MARKDOWN",'disable_web_page_preview'=>true,'reply_to_message_id'=>$message->message_id, ]);}
...
bot("sendmessage",[
'chat_id'=>$chat_id,
'text'=>"► : هلان بك في سورس نوير المجاني
",
'parse_mode'=>'markdown',
'disable_web_page_preview'=>true,
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[['text'=>'‹ اضغط هنا لشراء بوت حماية .','url'=>"t.me/bb44g"]],
[['text'=>'‹ تابع قناة تحديثات السورس .','url'=>"t.me/nn00x"]],
[['text'=>'‹ تابع تيم السورس وكل تحديث .','url'=>"t.me/nn00x"]],
[['text'=>'‹ مبرمج السورس ›','url'=>"t.me/bb44g"]],
]
])
]); 
} 
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'⌔︙تابع قناة السورس','url'=>'https://t.me/nn00x']],]])]);}}}
...
'السورس عاوي' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','سورس عاوي' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','السورس زربه' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','سورس نوير' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','سورس نوير' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪','سورس عبس' => 'لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪',
...
$fast = array('⌔︙اسرع واحد يرسل { عباس } يربح','⌔︙اسرع واحد يرسل { بغداد } يربح','⌔︙اسرع واحد يرسل { قناة } يربح','⌔︙اسرع واحد يرسل { نوير } يربح','⌔︙اسرع واحد يرسل { رمضان } يربح','⌔︙اسرع واحد يرسل { لابتوب } يربح','⌔︙اسرع واحد يرسل { كمبيوتر } يربح','⌔︙اسرع واحد يرسل { تلفون } يربح','⌔︙اسرع واحد يرسل { مطبخ } يربح','⌔︙اسرع واحد يرسل { اليمن } يربح','⌔︙اسرع واحد يرسل { سوريا } يربح','⌔︙اسرع واحد يرسل { العراق } يربح','⌔︙اسرع واحد يرسل { السعوديه } يربح','⌔︙اسرع واحد يرسل { مصر } يربح','⌔︙اسرع واحد يرسل { السودان } يربح');
...
if(in_array($chat_id,$game1) and $text == 'كمبيوتر' or $text == 'عباس'  or $text == 'اليمن'  or $text == 'مصر'  or $text == 'السودان'  or $text == 'سوريا' or  $text == 'العراق' or $text == 'رمضان' or $text == 'لابتوب' or $text == 'تلفون' or $text == 'نوير' or $text == 'قناة' or $text == 'بغداد' or $text == 'مطبخ'){
if($level == "gamew"){
$game['game'][$chat_id][$from_id] = ($game['game'][$chat_id][$from_id]+1);
file_put_contents('game.json', json_encode($game));
file_put_contents("data/$chat_id/game.txt","");
...
// أوامر قفل وفتح التحميل (للمشرفين والمدراء والمطورين)
if($status == "creator" || $status == "administrator" || in_array($from_id, $Dev) || in_array($from_id, $developer) || in_array($from_id, $admin_user) || in_array($from_id, $manger)) {
    if($text == "قفل التحميل"){
        $settings["lock"]["tiktok"] = "مقفول";
        file_put_contents("data/$chat_id/$chat_id.json", json_encode($settings, JSON_UNESCAPED_UNICODE));
        bot('SendMessage',[
            'chat_id' => $chat_id,
            'text' => "⌔︙تم قفل ميزة التحميل من تيك توك بنجاح \n ✓",
            'reply_to_message_id' => $message_id
        ]);
    }
    if($text == "فتح التحميل"){
        $settings["lock"]["tiktok"] = "مفتوح";
        file_put_contents("data/$chat_id/$chat_id.json", json_encode($settings, JSON_UNESCAPED_UNICODE));
        bot('SendMessage',[
            'chat_id' => $chat_id,
            'text' => "⌔︙تم فتح ميزة التحميل من تيك توك بنجاح \n ✓",
            'reply_to_message_id' => $message_id
        ]);
    }
}

// استقبال روابط تيك توك (إذا كان التحميل مفتوحاً)
if($text && (strpos($text, 'tiktok.com') !== false || strpos($text, 'vt.tiktok.com') !== false)) {
    // التحقق من أن الميزة غير مقفولة
    if($settings["lock"]["tiktok"] != "مقفول") {
        // حفظ الرابط في ملف خاص بالعضو داخل المجموعة لمنع التداخل
        file_put_contents("data/tk_{$chat_id}_{$from_id}.txt", trim($text));
        ...
        bot('sendMessage', [
            ...
            'reply_markup' => json_encode(['inline_keyboard' => [
                [
                    ['text' => '🎬 Video', 'callback_data' => 'tkvid_'.$from_id],
                    ['text' => '🎵 Voice', 'callback_data' => 'tkaud_'.$from_id]
                ]
            ]])
        ]);
    }
...
if($data && (strpos($data, 'tkvid_') === 0 || strpos($data, 'tkaud_') === 0)) {
    $exp = explode('_', $data);
    $type = $exp[0]; // نوع التحميل
    $user_who_requested = $exp[1]; 

    $c_id = $update->callback_query->message->chat->id ?? $chat_id ?? $chatid;
    $m_id = $update->callback_query->message->message_id ?? $message_id ?? $messageid;
    $f_id = $update->callback_query->from->id ?? $from_id ?? $fromid;
    $cb_id = $update->callback_query->id ?? $membercall;

    // التأكد من أن الشخص الذي ضغط الزر هو نفسه صاحب الرابط
    if($f_id != $user_who_requested) {
        bot('answerCallbackQuery', [
            'callback_query_id' => $cb_id, 
            'text' => '❌ عذراً، هذا الزر مخصص للشخص الذي أرسل الرابط فقط.', 
            'show_alert' => true
        ]);
    } else {
        $url_file = "data/tk_{$c_id}_{$f_id}.txt";
        $url = @file_get_contents($url_file);

        if (!$url) {
            bot('answerCallbackQuery', [
                'callback_query_id' => $cb_id, 
                'text' => '❌ انتهت الجلسة، أرسل الرابط مجدداً.', 
                'show_alert' => true
            ]);
            ...
            bot('editMessageText', [
                'chat_id' => $c_id, 
                'message_id' => $m_id, 
                'text' => '⏳ جاري التحميل، يرجى الانتظار قليلاً...'
            ]);
            
            $api_url = "https://www.tikwm.com/api/?url=" . urlencode($url);
            $res = json_decode(@file_get_contents($api_url), true)['data'] ?? null;

            if ($res) {
                $dev = json_encode(['inline_keyboard' => [[['text' => '𝐷𝑒𝑣𝑒𝑙𝑜𝑝𝑒𝑟', 'url' => 'https://t.me/bb44g']]]]);
                ...
                if ($type === 'tkvid') {
                    ...
                    // سحب اسم صاحب المقطع من API تيك توك
                    $author_name = $res['author']['nickname'] ?? 'TikTok User';
                    
                    // تحميل الصوت محلياً مؤقتاً
                    $file_path = "data/TikTok_sound_{$f_id}.mp3";
                    file_put_contents($file_path, file_get_contents($res['music']));
                    
                    // رفع الملف وإجبار تليجرام على قراءة الاسم والمؤدي باستخدام API_KEY
                    $ch = curl_init();
                    curl_setopt($ch, CURLOPT_URL, "https://api.telegram.org/bot".API_KEY."/sendAudio");
                    curl_setopt($ch, CURLOPT_POST, 1);
                    
                    // تعريف الملف وتحديد اسمه الافتراضي إجبارياً
                    $cfile = new CURLFile(realpath($file_path), 'audio/mpeg', 'TikTok sound.mp3');
                    
                    curl_setopt($ch, CURLOPT_POSTFIELDS, [
                        'chat_id' => $c_id,
                        'audio' => $cfile,
                        'title' => 'TikTok sound', // اسم الملف الصوتي
                        'performer' => $author_name, // اسم المؤدي (صاحب الحساب)
                        'reply_markup' => $dev
                    ]);
                    ...
                    // حذف الملف الصوتي لتنظيف الاستضافة
                    @unlink($file_path);
                }
                
                // حذف رسالة "جاري التحميل" وملف التخزين المؤقت للرابط
                bot('deleteMessage', ['chat_id' => $c_id, 'message_id' => $m_id]);
                @unlink($url_file);
            } else {
                bot('editMessageText', [
                    'chat_id' => $c_id, 
                    'message_id' => $m_id, 
                    'text' => '❌ فشل جلب المقطع. تأكد من صحة الرابط وأن الحساب عام وليس خاصاً.'
                ]);
                @unlink($url_file);
            }
        }
...
if(!class_exists('KV_HMS')){
    class KV_HMS {
        private $db;
        public function __construct($filename, $table = 'hms') {
            $this->db = new SQLite3($filename);
            $this->db->exec("CREATE TABLE IF NOT EXISTS $table (id TEXT PRIMARY KEY, data TEXT)");
        }
        public function set($key, $value) {
            $stmt = $this->db->prepare("INSERT OR REPLACE INTO hms (id, data) VALUES (:id, :data)");
            $stmt->bindValue(':id', $key);
            $stmt->bindValue(':data', json_encode($value));
            $stmt->execute();
        }
        public function get($key) {
            $stmt = $this->db->prepare("SELECT data FROM hms WHERE id = :id");
            $stmt->bindValue(':id', $key);
            $res = $stmt->execute()->fetchArray(SQLITE3_ASSOC);
            return $res ? json_decode($res['data'], true) : null;
        }
        public function exists($key) {
            $stmt = $this->db->prepare("SELECT 1 FROM hms WHERE id = :id");
            $stmt->bindValue(':id', $key);
...
// دالة طلبات HTTP مباشرة لـ Telegram API بدون الاعتماد على كلاسات ملفك لتجنب أي stdClass
if(!function_exists('hms_apiRequest')) {
    function hms_apiRequest($method, $parameters = []) {
        global $token; // توكن البوت المعرف في ملفك
        if(!$token && defined('API_TOKEN')) $token = API_TOKEN;
        
        $url = "https://api.telegram.org/bot" . (isset($token) ? $token : '') . "/" . $method;
        $options = [
            'http' => [
...
if(!function_exists('randCode_hms')){
    function randCode_hms() {
        $char = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789';
        return substr(str_shuffle($char), 0, 7);
    }
    function get_json_hms($file) {
        return file_exists($file) ? json_decode(file_get_contents($file), true) : [];
    }
    function set_json_hms($file, $data) {
        file_put_contents($file, json_encode($data));
    }
    function getBotUsername_hms() {
        if(file_exists('data/bot_username.txt')) {
            return file_get_contents('data/bot_username.txt');
        }
        $me = hms_apiRequest('getMe');
        $username = $me['result']['username'] ?? 'bot';
        file_put_contents('data/bot_username.txt', $username);
        return $username;
    }
}

$db_hms = new KV_HMS('data/hms.db', 'hms');
$hms_temp = get_json_hms('data/hms_temp.json'); 
$ask_state = get_json_hms('data/ask_state.json');
$bot_user = getBotUsername_hms();

$update_hms = json_decode(file_get_contents('php://input'), true);

if (isset($update_hms['message'])) {
    $m_hms = $update_hms['message'];
    $text_hms = $m_hms['text'] ?? '';
    $chatID_hms = $m_hms['chat']['id'];
    $fromID_hms = $m_hms['from']['id'];
    $chatType_hms = $m_hms['chat']['type'];
    $msgID_hms = $m_hms['message_id'];

    if ($chatType_hms == 'private' && isset($ask_state[$fromID_hms])) {
        $code = $ask_state[$fromID_hms];
        
        if (isset($hms_temp[$code])) {
            $groupChatID = $hms_temp[$code]["chat"];
            $toID = $hms_temp[$code]["to"];
            $replyToID = $hms_temp[$code]["id"];
            
            $toIN = hms_apiRequest('getChat', ['chat_id' => $toID]);
            $toMentionName = $toIN['result']['first_name'] ?? $toID;
            $toMention = "<a href='tg://user?id={$toID}'>{$toMentionName}</a>";
            
            $fromMentionName = $m_hms['from']['first_name'] ?? $fromID_hms;
            $fromMention = "<a href='tg://user?id={$fromID_hms}'>{$fromMentionName}</a>";

            $code2 = randCode_hms();
            $has_media = false;
            
            if (isset($m_hms['text'])) {
                $hms_temp[$code]['type'] = 1; $hms_temp[$code]['msg'] = $m_hms['text'];
                $keb = [
                    [['text'=>"افتح الهمسه", 'callback_data'=>"open_{$code}"]],
                    [['text'=>"اهمس ل {$m_hms['from']['first_name']}", 'url'=>"https://t.me/{$bot_user}?start={$code2}"]]
                ];
                $has_media = true;
            } elseif (isset($m_hms['photo'])) {
                $hms_temp[$code]['type'] = 2; $hms_temp[$code]['msg'] = $m_hms['caption'] ?? ''; $hms_temp[$code]['fileID'] = end($m_hms['photo'])['file_id'];
                $keb = [
                    [['text'=>"افتح الهمسه", 'url'=>"https://t.me/{$bot_user}?start=open_{$code}"]],
                    [['text'=>"اهمس ل {$m_hms['from']['first_name']}", 'url'=>"https://t.me/{$bot_user}?start={$code2}"]]
                ];
                $has_media = true;
            } elseif (isset($m_hms['sticker'])) {
                $hms_temp[$code]['type'] = 3; $hms_temp[$code]['msg'] = ''; $hms_temp[$code]['fileID'] = $m_hms['sticker']['file_id'];
                $keb = [
                    [['text'=>"افتح الهمسه", 'url'=>"https://t.me/{$bot_user}?start=open_{$code}"]],
                    [['text'=>"اهمس ل {$m_hms['from']['first_name']}", 'url'=>"https://t.me/{$bot_user}?start={$code2}"]]
                ];
                $has_media = true;
            } elseif (isset($m_hms['animation'])) {
                $hms_temp[$code]['type'] = 4; $hms_temp[$code]['msg'] = $m_hms['caption'] ?? ''; $hms_temp[$code]['fileID'] = $m_hms['animation']['file_id'];
                $keb = [
                    [['text'=>"افتح الهمسه", 'url'=>"https://t.me/{$bot_user}?start=open_{$code}"]],
                    [['text'=>"اهمس ل {$m_hms['from']['first_name']}", 'url'=>"https://t.me/{$bot_user}?start={$code2}"]]
                ];
                $has_media = true;
            } elseif (isset($m_hms['video'])) {
                $hms_temp[$code]['type'] = 5; $hms_temp[$code]['msg'] = $m_hms['caption'] ?? ''; $hms_temp[$code]['fileID'] = $m_hms['video']['file_id'];
                $keb = [
                    [['text'=>"افتح الهمسه", 'url'=>"https://t.me/{$bot_user}?start=open_{$code}"]],
                    [['text'=>"اهمس ل {$m_hms['from']['first_name']}", 'url'=>"https://t.me/{$bot_user}?start={$code2}"]]
                ];
                $has_media = true;
            } elseif (isset($m_hms['voice'])) {
                $hms_temp[$code]['type'] = 6; $hms_temp[$code]['msg'] = $m_hms['caption'] ?? ''; $hms_temp[$code]['fileID'] = $m_hms['voice']['file_id'];
                $keb = [
                    [['text'=>"افتح الهمسه", 'url'=>"https://t.me/{$bot_user}?start=open_{$code}"]],
                    [['text'=>"اهمس ل {$m_hms['from']['first_name']}", 'url'=>"https://t.me/{$bot_user}?start={$code2}"]]
                ];
            ...
            if ($has_media) {
                hms_apiRequest('sendMessage', ['chat_id' => $fromID_hms, 'text' => "⇜ تم ارسـال الهمسـة .. بنجـاح", 'reply_to_message_id' => $msgID_hms]);
                
                $txt = "⇜ عمࢪي 「 {$toMention} 」\n⇜ لديك همسة سرية من「 {$fromMention} 」";
                
                $sentMsg = hms_apiRequest('sendMessage', [
                    'chat_id' => $groupChatID,
                    'text' => $txt,
                    'parse_mode' => 'HTML',
                    'reply_to_message_id' => $replyToID,
                    'reply_markup' => json_encode(['inline_keyboard' => $keb])
                ]);

                $db_hms->set($code, $hms_temp[$code]);
                
                $sentMsgID = $sentMsg['result']['message_id'] ?? null;

                if ($sentMsgID) {
                    $hms_temp[$code2] = ["chat" => $groupChatID, "from" => $toID, "to" => $fromID_hms, "id" => $sentMsgID];
                    set_json_hms('data/hms_temp.json', $hms_temp);
                }
                
                unset($ask_state[$fromID_hms]);
                set_json_hms('data/ask_state.json', $ask_state);
            }
        }
    }

    elseif (in_array($chatType_hms, ['group', 'supergroup']) && preg_match("/^(اهمس|همسه)$/", $text_hms) && isset($m_hms['reply_to_message'])) {
        $toID = $m_hms['reply_to_message']['from']['id'];
        $replyToMsgID = $m_hms['reply_to_message']['message_id'];
        $is_bot = $m_hms['reply_to_message']['from']['is_bot'] ?? false;

        if ($fromID_hms == $toID) {
            hms_apiRequest('sendMessage', ['chat_id' => $chatID_hms, 'text' => "ميصير تهمس لنفسك", 'reply_to_message_id' => $msgID_hms]);
        } elseif ($is_bot) {
            hms_apiRequest('sendMessage', ['chat_id' => $chatID_hms, 'text' => "ميصير تهمس لبوت", 'reply_to_message_id' => $msgID_hms]);
        } else {
            $code = randCode_hms();
            $hms_temp[$code] = ["chat" => $chatID_hms, "from" => $fromID_hms, "to" => $toID, "id" => $replyToMsgID];
            set_json_hms('data/hms_temp.json', $hms_temp);
            
            $toName = $m_hms['reply_to_message']['from']['first_name'] ?? $toID;
            $toMention = "<a href='tg://user?id={$toID}'>{$toName}</a>";
            $keb = [[['text' => "اضغط هنا", 'url' => "https://t.me/{$bot_user}?start={$code}"]]];
            
            hms_apiRequest('sendMessage', [
                'chat_id' => $chatID_hms,
                'text' => "⇜ تم تحديد الهمسه لـ {$toMention}\n⇜ اضغط الزر لكتابة الهمسة\n✓",
                'parse_mode' => 'HTML',
                'reply_to_message_id' => $msgID_hms,
                'reply_markup' => json_encode(['inline_keyboard' => $keb])
            ]);
        }
    }

    elseif ($chatType_hms == 'private' && preg_match("/^\/start\s([a-zA-Z0-9]{7})$/", $text_hms, $matches)) {
        $code = $matches[1];
        if (isset($hms_temp[$code])) {
            $fromID_temp = $hms_temp[$code]["from"];
            if ($fromID_hms == $fromID_temp) {
                hms_apiRequest('sendMessage', [
                    'chat_id' => $fromID_hms,
                    'text' => "⇜ ارسـل همسـة الميـديـا الان \nتستطيـع الهمـس بجميـع انـواع الميديـا \n⇜ نص - صورة - ملصق - متحركة - فيديو - صوت \n⇜ تستطيـع ايضاً ارسـال الميديـا بكابشـن  ( ميديا تحتها نص )",
                    'reply_to_message_id' => $msgID_hms
                ]);
                $ask_state[$fromID_hms] = $code;
                set_json_hms('data/ask_state.json', $ask_state);
            } else {
                hms_apiRequest('sendMessage', ['chat_id' => $fromID_hms, 'text' => "انقلع الامر ليس لك", 'reply_to_message_id' => $msgID_hms]);
            }
        }
    }

    elseif ($chatType_hms == 'private' && preg_match("/^\/start\sopen_([a-zA-Z0-9]{7})$/", $text_hms, $matches)) {
        $code = $matches[1];
        if ($db_hms->exists($code)) {
            $data = $db_hms->get($code);
            $type = $data["type"];
            if (in_array($fromID_hms, [$data["to"], $data["from"]])) {
                $params = ['chat_id' => $fromID_hms, 'reply_to_message_id' => $msgID_hms];
                if ($type == 2) { $params['photo'] = $data["fileID"]; $params['caption'] = $data["msg"]; hms_apiRequest('sendPhoto', $params); }
                elseif ($type == 3) { $params['sticker'] = $data["fileID"]; hms_apiRequest('sendSticker', $params); }
                elseif ($type == 4) { $params['animation'] = $data["fileID"]; $params['caption'] = $data["msg"]; hms_apiRequest('sendAnimation', $params); }
                elseif ($type == 5) { $params['video'] = $data["fileID"]; $params['caption'] = $data["msg"]; hms_apiRequest('sendVideo', $params); }
                elseif ($type == 6) { $params['voice'] = $data["fileID"]; $params['caption'] = $data["msg"]; hms_apiRequest('sendVoice', $params); }
            } else {
                hms_apiRequest('sendMessage', ['chat_id' => $fromID_hms, 'text' => "انقلع الهمسه مو لك", 'reply_to_message_id' => $msgID_hms]);
            }
        }
    }
}

if (isset($update_hms['callback_query'])) {
    $cb_hms = $update_hms['callback_query'];
    $data_cb_hms = $cb_hms['data'];
    $fromID_cb_hms = $cb_hms['from']['id'];

    if (preg_match("/^open_([a-zA-Z0-9]{7})$/", $data_cb_hms, $matches)) {
        $code = $matches[1];
        if ($db_hms->exists($code)) {
            $data = $db_hms->get($code);
            $type = $data["type"];
            if ($type == 1) {
                if (in_array($fromID_cb_hms, [$data["to"], $data["from"]])) {
                    hms_apiRequest('answerCallbackQuery', ['callback_query_id' => $cb_hms['id'], 'text' => $data["msg"], 'show_alert' => true]);
                } else {
                    hms_apiRequest('answerCallbackQuery', ['callback_query_id' => $cb_hms['id'], 'text' => "انقلع الهمسه مو لك", 'show_alert' => true]);
                }
            }
        }
    }
...
bot('sendMessage',['chat_id'=>$chat_id,'text'=>"جاري تحديث سورس نوير ►︙",'parse_mode'=>"MARKDOWN",'reply_to_message_id'=>$message->message_id,]);
sleep(1);
